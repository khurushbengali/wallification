...
namespace WallpaperCreator.OnScreen {
    ...
    public class FinalPage : Box {
        ...
        Image logo = new Image.from_file("/System/Resources/Wallification/done.svg");
        ...
        public FinalPage() {
            ...
            var mv_command = @"sudo mv $(Environment.get_home_dir())/$(wallpaperName.replace(" ", "_").replace(".", "_").down()) /System/Resources/Wallification";
