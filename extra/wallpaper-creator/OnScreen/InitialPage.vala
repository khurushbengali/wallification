...
namespace WallpaperCreator.OnScreen {
    ...
    public class InitialPage : Box {
        ...
        public InitialPage() {
            ...
            titleLabel.set_markup("<span font='Lato Light 30px' color='white'>Wallification Wallpaper Creator</span>");
            ...
            aboutGrid.attach(new Image.from_file("/System/Resources/Wallification/wallpaper_creator.svg"), 0, 0, 1, 1);
