...
namespace Wallification.OnScreen {
	...
	private class Thumbnail : EventBox {
		...
		Image borderImage = new Image.from_file("/System/Resources/Wallification/thumbnail_border.svg");
		...
		public Thumbnail.Add() {
			...
			thumbnailImage.pixbuf = new Gdk.Pixbuf.from_file_at_scale("/System/Resources/Wallification/thumbnail_add.svg", 150, 100, false);
