...
namespace Wallification.OnScreen {
	...
	public class WallpapersSelector : ScrolledWindow {
		...
		public string path = "/System/Resources/Wallification/";
		...
		public void getWallpapers () {
			...
			File wallpapersFolder = File.new_for_path("/System/Resources/Wallification");
			...
			try {
				...
				print("Could not read directory '/System/Resources/Wallification/'");
			}
		}
