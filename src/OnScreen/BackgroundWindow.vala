		...
		void setWallpaper() {
			...
			if(enableVideoWallpapers) {
				...
				if(wallpaperType == "video") {
					...
					var videoPath = @"file:///System/Resources/Wallification/$wallpaperName/$videoFileName";
			...
			wallpaperPixbuf = new Gdk.Pixbuf.from_file_at_scale(@"/System/Resources/Wallification/$wallpaperName/wallpaper.jpg",
