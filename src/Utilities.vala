...
using Wallification.OnScreen;

namespace Wallification.Utilities {

	// Wallification variables
	string desktopPath;
	...
	public void readConfigurationFile () {
		...
		if(configFilePath == null)
			configFilePath = Environment.get_home_dir() + "/.Wallification.prop";
	...
	void readWallpaperFile () {
		...
		var wallpaperPath = @"/System/Resources/Wallification/$wallpaperName";
		...
		if(wallpaperName == null || !File.new_for_path(wallpaperPath).query_exists() ||
			...
			wallpaperName = "foggy_sunny_mountain";
			wallpaperPath = @"/System/Resources/Wallification/$wallpaperName";
		...
		var wallpaperJpgPath = @"/System/Resources/Wallification/$wallpaperName/wallpaper.jpg";
